  ...
  return (
    <section className="flex flex-col items-center py-24 w-full [background:linear-gradient(180deg,rgba(4,5,16,1)_0%,rgba(7,5,18,1)_100%)]">
      ...
      <div className="relative max-w-[1200px] w-full">
        <h2 className="w-80 mx-auto [background:linear-gradient(90deg,rgba(163,255,18,1)_0%,rgba(197,255,107,1)_100%)] [-webkit-background-clip:text] bg-clip-text [-webkit-text-fill-color:transparent] [text-fill-color:transparent] [font-family:'Arial-Bold',Helvetica] font-bold text-transparent text-[40px] text-center tracking-[0] leading-[48px] whitespace-nowrap">
          EMPEROR PASS
        </h2>
        ...
        <div className="flex flex-col max-w-[800px] w-full mx-auto mt-16">
          <p className="w-fit mx-auto [font-family:'Arial-Narrow',Helvetica] font-normal text-gray-400 text-[17.6px] text-center tracking-[0] leading-[28.2px]">
            Only 50 emperor pass NFTs will exist. Each pass grants exclusive
            benefits and privileges within The
            <br />
            Empire.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-16">
              ...
              <div className="flex flex-col gap-[15.5px]">
                {eliteBenefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-4">
                    <CheckIcon className="text-[#a3ff12] w-4 h-4" />
          ...
          <Card className="w-[556px] border border-solid border-[#141625] shadow-[0px_10px_30px_#00000080] [background:linear-gradient(143deg,rgba(7,5,18,1)_0%,rgba(4,5,16,1)_100%)] rounded-xl relative">
            <CardContent className="p-8 flex flex-col items-center">
              ...
              <p className="[font-family:'Arial-Narrow',Helvetica] font-normal text-gray-300 text-base text-center tracking-[0] leading-[25.6px] mb-8">
                This NFT certifies the holder as a permanent member of Emperor
                <br />
                Elite Circle. Full access to private events, alpha intel, and
                exclusive
                <br />
                drops.
              </p>
              ...
              <div className="flex gap-4 mb-8">
                {socialIcons.map((Icon, index) => (
                  ...
                  >
                    <Icon className="text-[#a3ff12] w-4 h-4" />
                  </div>
                ))}
              </div>
